...
function calculateClientPrice(options) {
  ...
  if (options.service) {
    ...
    const pageCost =
      (PRICES[options.printType] || 0) + (PRICES[options.layout] || 0);
    ...
    <div className="page-container">
      ...
      <div className="hero-section page-section">
        ...
        <p className="subtitle">
          Upload your file, choose your options, and pick it up when it&apos;s
          ready.
        </p>
        ...
        <div className="how-it-works">
          <div className="step-card">
            ...
            <p className="step-desc">
              Select your PDF, JPG, or PNG file from your device.
            </p>
          </div>
          <div className="step-card">
            <div className="step-header">
            ...
            <p className="step-desc">
              Choose your print options and pay securely online.
            </p>
          </div>
          <div className="step-card">
            <div className="step-header">
            ...
            <p className="step-desc">
              Receive a unique token (e.g., B-101) for your order.
            </p>
          </div>
        </div>
        ...
        <div style={{ maxWidth: 640, margin: "2rem auto 0" }}>
          {!currentFile ? (
            <>
              ...
              <p className="file-accept-text">
                Accepted files: PDF, JPG, PNG. Max size: 30MB.
              </p>
            </>
          ) : (
                ...
                <>
                  ...
                  <div className="form-group">
                    ...
                    <input
                      ...
                      onChange={(e) =>
                        updateOption("pages", parseInt(e.target.value) || 1)
                      }
                    />
                  </div>
                  <div className="form-group">
                    ...
                    <div className="radio-group">
                      <label className="radio-label">
                        <input
                          ...
                          onChange={(e) =>
                            updateOption("printType", e.target.value)
                          }
                        />
                        B&W
                      </label>
                    ...
                    >
                      <label className="checkbox-label">
                        <input
                          ...
                          onChange={(e) =>
                            updateOption("firstPageColor", e.target.checked)
                          }
                        />
                    ...
                    <div className="radio-group">
                      <label className="radio-label">
                        <input
                          ...
                          onChange={(e) =>
                            updateOption("layout", e.target.value)
                          }
                        />
                        Single-Sided
                      </label>
                    ...
                    <div className="radio-group">
                      <label className="radio-label">
                        <input
                          ...
                          onChange={(e) =>
                            updateOption("binding", e.target.value)
                          }
                        />
                        None
                      </label>
      ...
      {tokenModal.show && (
        ...
        >
          <div className="modal-content" onClick={(e) => e.stopPropagation()}>
            ...
            <p>
              Your order has been placed. Please show this token ID at the
              counter to collect your documents.
            </p>
